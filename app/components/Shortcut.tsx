...
const Shortcut: React.FC<ShortcutProps> = ({
  ...
  return (
    ...
    >
      ...
      <span className="mt-2 text-xs font-medium text-slate-700 dark:text-slate-300 bg-white/50 dark:bg-black/40 backdrop-blur-sm px-2 py-0.5 rounded shadow-sm group-hover:bg-white/80 dark:group-hover:bg-black/60 transition-colors text-center w-full wrap-break-word">
        {label}
      </span>
    </div>
  );
